...
const services: Service[] = [
  { icon: <Monitor size={18} />, title: "Frontend Development",
    desc: "Desenvolvimento de interfaces do zero ou a partir de design no Figma, priorizando acessibilidade e responsividade." },
  { icon: <Palette size={18} />, title: "UX/UI Designing",
    desc: "Desenho interfaces limpas, acessíveis e consistentes, do wireframe ao protótipo, sempre focadas no usuário." },
  { icon: <Code2 size={18} />, title: "Full Stack Development",
    desc: "Eu entrego soluções full-stack com abordagem focada no frontend e bases sólidas de backend." },
];

export default function Services() {
  return (
    <section id="services" className="w-full scroll-mt-28 px-5 sm:px-6 md:px-24 py-14 md:py-16">
      ...
      <div className="max-w-5xl mx-auto grid gap-x-12 gap-y-8 md:grid-cols-[1.1fr_.9fr] md:grid-rows-[auto_1fr]">
        ...
        <div className="md:col-span-2">
          ...
          <motion.p
            ...
            // se usa Tailwind 3.3+: adicione "text-pretty" para melhor quebra tipográfica
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="flex flex-col">
          ...
          >
            {services.map((s, i) => (
              <motion.div key={i} variants={item} className="grid grid-cols-[28px_1fr] gap-3 p-5 md:p-6">
                <div
                ...
                <div>
                  <h4 className="text-sm md:text-base font-semibold text-foreground">{s.title}</h4>
